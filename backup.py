...
If you are unsure how to answer the question based on the database schema or if the question is completely unrelated, truthfully respond with "I can only answer anything related to Claims or Retail Schema".
